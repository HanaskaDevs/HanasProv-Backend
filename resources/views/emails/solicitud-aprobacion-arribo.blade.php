        ...
        <tr>
          <td style="padding:0 32px 8px 32px;">
            ...
            <p style="margin:0 0 16px 0; font-size:15px; line-height:1.6; color:#142831;">
              El proveedor <strong>{{ $nombreProveedor }}</strong> llegó fuera del horario y el Guardia solicita
              aprobación para registrar su arribo. El horario quedó marcado como <strong>Rechazado</strong> y
              solo puede pasar a Arribo si esta solicitud se aprueba.
            </p>
          </td>
        </tr>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f5f7f8; border-radius:8px; border:1px solid #e2e8ea;">
              <tr>
                <td style="padding:16px;">
                  <p style="margin:0 0 10px 0; font-size:11px; text-transform:uppercase; letter-spacing:0.5px; color:#6b7c82;">Proveedor</p>
                  <p style="margin:0 0 14px 0; font-size:15px; font-weight:bold; color:#142831;">{{ $nombreProveedor }}</p>

                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td style="font-size:13px; color:#6b7c82; padding:4px 0;">Hora programada</td>
                      <td align="right" style="font-size:14px; color:#142831; padding:4px 0;">{{ $horaProgramada }}</td>
                    </tr>
                    <tr>
                      <td style="font-size:13px; color:#6b7c82; padding:4px 0;">Solicitado por</td>
                      <td align="right" style="font-size:14px; color:#142831; padding:4px 0;">{{ $nombreSolicitante }}</td>
                    </tr>
                    <tr>
                      <td style="font-size:13px; color:#6b7c82; padding:4px 0;">Fecha de solicitud</td>
                      <td align="right" style="font-size:14px; font-weight:bold; color:#142831; padding:4px 0;">{{ $fechaSolicitud }}</td>
                    </tr>
                  </table>
                </td>
              </tr>
